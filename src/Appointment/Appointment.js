...
const PatientAppointment = ({patient_id}) => {
    ...
    const [patientAppointment, setPatientAppointment] = useState(initialPatientAppointmentState);
    const [currentPatientAppointment, setCurrentPatientAppointment] = useState(null);
