...
const SymptomForm = ({symptom, hideModal, visibility, setSymptom, saveSymptom, updateSymptomButton, symptomGroups}) => {
        ...
        <>
            <Modal show={visibility} onHide={hideModal}>
                ...
                <Modal.Body>
                    <Form
                        fluid
                        formValue={symptom} onChange={symptom => setSymptom(symptom)}
                    >
                        <FormGroup>
                        ...
                        <FormGroup>
                            ...
                            <FormControl name="group" accepter={SelectPicker}
