...
const PatientTreatment = ({ patient_id, currentTreatment }) => {
  ...
  const [patientTreatment, setPatientTreatment] = useState(
    initialPatientTreatmentState
  );
  const [currentPatientTreatment, setCurrentPatientTreatment] = useState(
    currentTreatment
  );
  ...
  return (
    <>
      ...
      <Button onClick={patientTreatmentFormButton}>
        {PatientTreatmentValues.listValues.new_title}{" "}
      </Button>
